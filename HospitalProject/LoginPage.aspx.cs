...
namespace HospitalProject
{
    public partial class LoginPage : System.Web.UI.Page
    {
        ...
        {
            var query = (from data in hsp.Doctors
                         where data.dt_TC == txtUserName.Value  && data.dt_Password == txtPassword.Value
                         select data).Any();
            ...
            else if (query)
            {
                ...
                Session["Login"] = hsp.Doctors.SingleOrDefault(u => u.dt_TC == txtUserName.Value).dt_TC;
