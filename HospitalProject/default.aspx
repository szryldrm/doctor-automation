<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="HospitalProject.Default" %>
                ...
                <div class="white-box">
                    <div class="form-horizontal form-material" id="loginform">
                        ...
                        <div class="form-group m-t-40">
                            <div class="col-xs-12">
                                <input required id="txtUserName" runat="server" class="form-control" type="text" placeholder="Kullanıcı Adınız">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-xs-12">
                                <input required id="txtPassword" runat="server" class="form-control" type="password" placeholder="Şifreniz">
                            </div>
                        </div>
